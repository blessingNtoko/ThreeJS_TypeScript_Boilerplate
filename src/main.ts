...
object1Folder.add(object1.position, 'x', 0, 10, .01).name('X Position');
object1Folder.add(object1.rotation, 'x', 0, Math.PI * 2, .01).name('X Rotation');
object1Folder.add(object1.scale, 'x', 0, 2, .01).name('X Scale');
object1Folder.open();

const object2Folder = gui.addFolder("Object2 (Greeb Ball)");
object2Folder.add(object2.position, 'x', 0, 10, .01).name('X Position');
object2Folder.add(object2.rotation, 'x', 0, Math.PI * 2, .01).name('X Rotation');
object2Folder.add(object2.scale, 'x', 0, 2, .01).name('X Scale');
object2Folder.open();

const object3Folder = gui.addFolder("Object3 (Blue Ball)");
object3Folder.add(object3.position, "x", 0, 10, .01).name('X Position');
object3Folder.add(object3.rotation, "x",0, Math.PI * 2, .01).name('X Rotation');
object3Folder.add(object3.scale, "x", 0, 2, .01).name('X Scale');
object3Folder.open();
